...
class Mylib {
    ...
    function nonotin($idkel){
        switch ($idkel) {
			case "1":$idkel = "DGS/12.3/";break;
			case "2":$idkel = "SPO/8.4/";break;
			case "3":$idkel = "SUP/10.2/";break;
			case "4":$idkel = "SCO//";break;
			case "5":$idkel = "SMN//";break;
			case "6":$idkel = "SGV7.3//";break;
			case "7":$idkel = "DSS//";break;
        }
        return $idkel;
    }
